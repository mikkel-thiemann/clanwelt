...
function drawBigMap() {
  ...
  lab('DonnerClan', 2350, 2100, '#ffd98a'); lab('SchattenClan', 2100, 420, '#c8b8ff'); lab('FlussClan', 520, 2000, '#9fd8ff'); lab('WindClan', 4400, 2000, '#fff3a0'); lab('Zweibeinerort', 2300, 4080, '#ddd'); lab('Hochland', 4500, 900, '#ddd');
