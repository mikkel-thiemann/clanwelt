...
function createStartCats() {
  const defs = [
    ...
    { id: 'goldbluete', pre: 'Gold', suf: 'blüte', rank: 'koenigin', age: 36, sex: 'w', look: L('#e5a84a', '#b8782a', 0, '#e8b923') },
    { id: 'kleinohr', pre: 'Klein', suf: 'ohr', rank: 'aeltester', age: 140, sex: 'm', look: L('#909098', null, 0, '#e8b923', { size: 0.95 }) },
